...
def root() -> str:
    ...
    <html lang="en">
      ...
      <body>
        <img class="static-logos" id="static-logos" src="https://raw.githubusercontent.com/saumyapratapsingh007/Servixa/main/assets/alllogos.png" alt="" />
        <img class="floating-scaler" id="floating-scaler" src="https://raw.githubusercontent.com/saumyapratapsingh007/Servixa/main/assets/floater.png" alt="" />
